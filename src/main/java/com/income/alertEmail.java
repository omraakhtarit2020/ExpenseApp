	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (email != null && !email.isEmpty()) {
			try {
				...
				sb.append("This email is to notify you about your expenses. As of now, you have already spent ")
						.append(expense).append(" rupees this month, which accounts to ").append(amt)
						.append("% of your total income which was last updated to ").append(income).append(" rupees.")
						.append(System.lineSeparator());
				sb.append(
						"It is important to stay mindful of your spending to ensure financial stability and achieve your long-term goals.")
						.append(System.lineSeparator());
				;
				sb.append(System.lineSeparator());
				sb.append(
						"We encourage you to explore all the features of our application with confidence. Our platform offers tailored "
								...
								+ "our calculators ensure accurate results every time.")
						.append(System.lineSeparator());
				sb.append(
						"Additionally, we provide comprehensive tracking tools for monitoring all your loans and borrowings, making financial management easy and efficient.")
						.append(System.lineSeparator());
				sb.append(System.lineSeparator());
				sb.append(
						"If the last transaction was not updated by you, then feel free to contact us at tracking.expense2024@gmail.com")
						.append(System.lineSeparator());
				sb.append(System.lineSeparator());
				sb.append(System.lineSeparator());
