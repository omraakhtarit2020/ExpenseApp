<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <% String message = (String)request.getAttribute("message"); %>
                ...
                <div class="box-root padding-top--24 flex-flex flex-direction--column"
                    ...
                    <div class="formbg-outer">
                        <div class="formbg">
							...
							<% } %>
                                <form action="ValidateOtp" method="POST" id="stripe-login">
                                    <div class="field padding-bottom--24">
                                        <label for="otp"><b>OTP</b>
                                        </label> <input id="otp" type="text" placeholder="" name="otp">
                                    </div>
                                    <div class="field padding-bottom--24">
                                        <button id="next" class="btn next">Next
                                        </button>
                                    </div>
                                    <div class="resendOtp" id="resendStatus">
                                        <a href="mailForget.jsp" id="resendOtp" >Re-send OTP</a>
                                    </div>
        ...
        <!--script>
    		...
    		// Execute the logic to resend OTP here
    		var xhr = new XMLHttpRequest(); // Create a new XMLHttpRequest object
    		xhr.open("POST", "/resendOtp", true); // Open a POST request to the forgotPassword servlet
    		...
    		xhr.onreadystatechange = function() {
                ...
                // Update the resendStatus element to show a message indicating that the OTP has been resent successfully
                		document.getElementById("resendStatus").innerText = "OTP resent successfully!";
            		} else {
                	// Update the resendStatus element to show a message indicating that there was an error
                		document.getElementById("resendStatus").innerText = "Error: Unable to resend OTP";
            		}
        		}
   		 		};
